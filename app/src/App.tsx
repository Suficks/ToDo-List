...
import EmptyImgLight from './Assets/empty-icon-light.svg';
import EmptyImgDark from './Assets/empty-icon-dark.svg';
    ...
    <div className={cn.wrapper}>
      ...
      <div className={cn.container}>
        <div className={cn.input_wrap}>
          ...
          />
          <div>
            <svg className={cn.search} width="21" height="22" viewBox="0 0 21 22" fill="var(--search-icon-color)" xmlns="http://www.w3.org/2000/svg">
      ...
      {filteredTasks.length === 0 ? (
        <div className={cn.empty_wrap}>
          {theme === 'dark'
            ? <img className={cn.emptyImg} src={EmptyImgDark} alt="" />
            : <img className={cn.emptyImg} src={EmptyImgLight} alt="" />}
